    ...
    <template>
      <section class="content element-doc">
        <h2 id="cascader-ji-lian-xuan-ze-qi"><a class="header-anchor" href="#cascader-ji-lian-xuan-ze-qi">¶</a> Cascader 级联选择器</h2>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="jin-yong-xuan-xiang"><a class="header-anchor" href="#jin-yong-xuan-xiang">¶</a> 禁用选项</h3>
...
<demo-block>
        ...
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader :options=&quot;options&quot;&gt;&lt;/el-cascader&gt;
...
<demo-block>
        ...
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader :options=&quot;options&quot; clearable&gt;&lt;/el-cascader&gt;
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="jin-xian-shi-zui-hou-yi-ji"><a class="header-anchor" href="#jin-xian-shi-zui-hou-yi-ji">¶</a> 仅显示最后一级</h3>
...
<demo-block>
        ...
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader :options=&quot;options&quot; :show-all-levels=&quot;false&quot;&gt;&lt;/el-cascader&gt;
...
<demo-block>
        <div><p>在开启多选模式后，默认情况下会展示所有已选中的选项的Tag，你可以使用<code>collapse-tags</code>来折叠Tag</p>
</div>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="xuan-ze-ren-yi-yi-ji-xuan-xiang"><a class="header-anchor" href="#xuan-ze-ren-yi-yi-ji-xuan-xiang">¶</a> 选择任意一级选项</h3>
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="dong-tai-jia-zai"><a class="header-anchor" href="#dong-tai-jia-zai">¶</a> 动态加载</h3>
...
<demo-block>
        ...
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader :props=&quot;props&quot;&gt;&lt;/el-cascader&gt;
...
<p>可以自定义备选项的节点内容</p>
<demo-block>
        <div><p>可以通过<code>scoped slot</code>对级联选择器的备选项的节点内容进行自定义，scoped slot会传入两个字段 <code>node</code> 和 <code>data</code>，分别表示当前节点的 Node 对象和数据。</p>
</div>
        <template slot="source"><element-demo8 /></template>
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader :options=&quot;options&quot;&gt;
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="ji-lian-mian-ban"><a class="header-anchor" href="#ji-lian-mian-ban">¶</a> 级联面板</h3>
<p>级联面板是级联选择器的核心组件，与级联选择器一样，有单选、多选、动态加载等多种功能。</p>
<demo-block>
        <div><p>和级联选择器一样，通过<code>options</code>来指定选项，也可通过<code>props</code>来设置多选、动态加载等功能，具体详情见下方API表格。</p>
</div>
        <template slot="source"><element-demo9 /></template>
        <template slot="highlight"><pre v-pre><code class="html">&lt;el-cascader-panel :options=&quot;options&quot;&gt;&lt;/el-cascader-panel&gt;
...
&lt;/script&gt;
</code></pre></template></demo-block><h3 id="cascader-attributes"><a class="header-anchor" href="#cascader-attributes">¶</a> Cascader Attributes</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<h3 id="cascader-events"><a class="header-anchor" href="#cascader-events">¶</a> Cascader Events</h3>
<table>
<thead>
<tr>
<th>事件名称</th>
...
<h3 id="cascader-methods"><a class="header-anchor" href="#cascader-methods">¶</a> Cascader Methods</h3>
<table>
<thead>
<tr>
<th>方法名</th>
...
<h3 id="cascader-slots"><a class="header-anchor" href="#cascader-slots">¶</a> Cascader Slots</h3>
<table>
<thead>
<tr>
<th>名称</th>
...
<h3 id="cascaderpanel-attributes"><a class="header-anchor" href="#cascaderpanel-attributes">¶</a> CascaderPanel Attributes</h3>
<table>
<thead>
<tr>
<th>参数</th>
...
<h3 id="cascaderpanel-events"><a class="header-anchor" href="#cascaderpanel-events">¶</a> CascaderPanel Events</h3>
<table>
<thead>
<tr>
<th>事件名称</th>
...
<h3 id="cascaderpanel-methods"><a class="header-anchor" href="#cascaderpanel-methods">¶</a> CascaderPanel Methods</h3>
<table>
<thead>
<tr>
<th>方法名</th>
...
<h3 id="cascaderpanel-slots"><a class="header-anchor" href="#cascaderpanel-slots">¶</a> CascaderPanel Slots</h3>
<table>
<thead>
<tr>
<th>名称</th>
  ...
  return _c("div", [
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("el-cascader", {
          attrs: { options: _vm.options, props: { expandTrigger: "hover" } },
          on: { change: _vm.handleChange },
          model: {
            value: _vm.value,
            callback: function($$v) {
...
render._withStripped = true
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [_c("el-cascader", { attrs: { options: _vm.options } })], 1)
}
var staticRenderFns = []
render._withStripped = true
  ...
  return _c(
    "div",
    [_c("el-cascader", { attrs: { options: _vm.options, clearable: "" } })],
    1
  )
}
var staticRenderFns = []
render._withStripped = true
  ...
  return _c(
    ...
    [
      _c("el-cascader", {
        attrs: { options: _vm.options, "show-all-levels": false }
      })
    ],
    1
  )
  ...
  return _c("div", [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("el-cascader", {
          attrs: { options: _vm.options, props: _vm.props, clearable: "" }
        })
      ],
      1
    ),
    ...
    _c(
      ...
      { staticClass: "block" },
      [
        _c("span", { staticClass: "demonstration" }, [_vm._v("折叠展示Tag")]),
        _vm._v(" "),
        _c("el-cascader", {
          attrs: {
            options: _vm.options,
...
render._withStripped = true
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [_c("el-cascader", { attrs: { props: _vm.props } })], 1)
}
var staticRenderFns = []
render._withStripped = true
  ...
  return _c("div", [
    _c(
      ...
      { staticClass: "block" },
      [
        _c("span", { staticClass: "demonstration" }, [_vm._v("单选可搜索")]),
        _vm._v(" "),
        _c("el-cascader", {
          attrs: {
            placeholder: "试试搜索：指南",
    ...
    _c(
      ...
      { staticClass: "block" },
      [
        _c("span", { staticClass: "demonstration" }, [_vm._v("多选可搜索")]),
        _vm._v(" "),
        _c("el-cascader", {
          attrs: {
            placeholder: "试试搜索：指南",
...
render._withStripped = true
  ...
  return _c(
    "div",
    [_c("el-cascader-panel", { attrs: { options: _vm.options } })],
    1
  )
}
var staticRenderFns = []
